...
time if [ -d "/media/destination_B" ] && [ "$bool_backup_folder_B" = true ] ; then
...
time if [ -d "/media/destination_quick" ] && [ -d "/media/destination_A" ] && [ -d "/media/destination_B" ] && [ "$bool_backup_folder_A" = true ] && [ "$bool_backup_folder_B" = true ] ; then
