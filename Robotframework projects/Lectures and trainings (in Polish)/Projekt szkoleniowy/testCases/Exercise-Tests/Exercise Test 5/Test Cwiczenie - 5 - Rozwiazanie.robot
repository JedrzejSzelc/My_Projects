...
*** Test Cases ***
Exercise-Test-5-Solution

    [Documentation]         Dokumentacja testu ćwiczenia nr 5 - Ćwiczenie nr 5: Listy z pęltą "FOR" oraz warunkiem "IF" - Rozwiązanie zadania
    [Tags]                  tag-testu-cwiczenia-nr-5-rozwiazanie
